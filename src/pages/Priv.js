...
function Profile() {
  ...
  useEffect(() => {
    axios
      .get(`https://portfolioau777.herokuapp.com/auth/postspriv/${id}`)
      .then((response) => {
    ...
    axios
      .get(`https://portfolioau777.herokuapp.com/postspriv/byuserId/${id}`)
      .then((response) => {
        ...
        <div className="">
          <div className="basicinfo3">
            ...
            <div className="profil">
              <img
                src={
                  "https://portfolioau777.herokuapp.com/images/" + photo_profil
                }
                alt="profil"
              />{" "}
            </div>
            {(authState.username === username || authState.admin === true) && (
              <>
                ...
                <form
                  action={"https://portfolioau777.herokuapp.com/upload/" + id}
                  method="POST"
