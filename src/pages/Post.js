...
function Post() {
  ...
  useEffect(() => {
    axios
      .get(`https://portfolioau777.herokuapp.com/posts/byId/${id}`)
      .then((response) => {
        setPostObject(response.data);
      });

    axios
      .get(`https://portfolioau777.herokuapp.com/comments/${id}`)
      .then((response) => {
  ...
  const addComment = () => {
    axios
      .post(
        "https://portfolioau777.herokuapp.com/comments",
        {
  ...
  const deleteComment = (id) => {
    axios
      .delete(`https://portfolioau777.herokuapp.com/comments/${id}`, {
  ...
  const deletePost = (id) => {
    axios
      .delete(`https://portfolioau777.herokuapp.com/posts/${id}`, {
        headers: { accessToken: localStorage.getItem("accessToken") },
      })
      .then(() => {
        history.push("/Home");
  ...
  const editPost = (option) => {
    if (option === "title") {
      ...
      axios.put(
        "https://portfolioau777.herokuapp.com/posts/title",
        {
          newTitle: newTitle,
          id: id,
        },
      ...
      axios.put(
        "https://portfolioau777.herokuapp.com/posts/postText",
        {
          newText: newPostText,
          id: id,
        },
