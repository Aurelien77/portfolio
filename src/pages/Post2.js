...
function Post2() {
  ...
  useEffect(() => {
    axios
      .get(`https://portfolioau777.herokuapp.com/postspriv/byId2/${id}`)
      .then((response) => {
        setPostObject(response.data);           /*  Set l'authState avec un post choisit par ID */
      });

    axios
      .get(`https://portfolioau777.herokuapp.com/comments2/${id}`)
      .then((response) => {
  ...
  const addComment = () => {
    axios
      .post(
        "https://portfolioau777.herokuapp.com/comments2",
        {
  ...
  const deleteComment = (id) => {
    axios
      .delete(`https://portfolioau777.herokuapp.com/comments2/${id}`, {
  ...
  const deletePost = (id) => {
    axios
      .delete(`https://portfolioau777.herokuapp.com/postspriv/${id}`, {
        headers: { accessToken: localStorage.getItem("accessToken") },
      })
      .then(() => {
        history.push("/Home");
  ...
  const editPost = (option) => {
    if (option === "title") {
      ...
      axios.put(
        "https://portfolioau777.herokuapp.com/postspriv/title",
        {
          newTitle: newTitle,
          id: id,
        },
      ...
      axios.put(
        "https://portfolioau777.herokuapp.com/postspriv/postText",
        {
          newText: newPostText,
          id: id,
        },
